 ...
 */
/*:ja
 * @plugindesc TOF風の代替メニュー
 * @author SumRndmDde
 *
 * @param "Play Time" Text
 * @text プレイ時間テキスト
 * @desc メニューの「プレイ時間」に使用するテキスト
 * @default プレイ時間
 *
 * @param Sprite Size Ratio
 * @text スプライトサイズの比率
 * @desc メニューの歩行キャラの大きさの比率
 * 通常:1 / 2倍:2 / 半分:0.5
 * @default 1
 *
 * @param Show White Borders?
 ...
 * @text キャラサイズ
 * @type number
 * @desc デフォルトでは48x48のキャラクタースプライトを使用
 * 他のサイズのスプライトを使う場合、入力
 * @default 48
 *
 * @param Command Columns
 * @text コマンド列数
 * @type number
 * @desc メニュー内のコマンドの最大列数
 * @default 4
 *
 * @param Command Rows
 * @text コマンド行数
 * @desc メニュー内のコマンドで表示される行数
 * @default 2
 *
 * @param Y Offset
 * @text 行間の距離
 * @type number
 * @desc アクター・メニュー・ステータスの情報の各行間の距離
 * @default 32
 *
 * @help
 * 翻訳:ムノクラ
 ...
 *
 * 元プラグイン: http://sumrndm.site/ams-phantasia/
 *
 * Alternative Menu Screen: Phantasia
 * Version 1.02
 * SumRndmDde
