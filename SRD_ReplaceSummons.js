 ...
 */
/*:ja
 * @plugindesc アクティブに使用者やパーティを入れ替える召喚を作成できます。
 * @author SumRndmDde
 *
 * @param Allow Turn Reset
 * @text ターンリセットを許可
 ...
 * @on 許可
 * @off 禁止
 * @desc パーティが入れ替わった時点で戦闘ターンを全てスキップし、入力フェーズに戻す
 * @default true
 *
 * @help
 * 翻訳:ムノクラ
 ...
 *
 * 元プラグイン: http://sumrndm.site/replace-summons/
 *
 *
 * Replace Summons
 * Version 1.00
 ...
 *
 * 交換召喚を設定するには、
 * 対応するスキルのメモ欄内に以下のメモタグを使用します。
 *
 *
 *   <Summon Replace Party>
 * 召喚スキルに配置すると、そのスキルは召喚が有効な間、
 * 一時的にパーティを除去します。
 *
 *
 *   <Summon Replace User>
