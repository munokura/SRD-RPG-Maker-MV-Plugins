 ...
 */
/*:ja
 * @plugindesc 開発者がテストゲーム内のGUIウィンドウを介して独自のマップベースのHUDを作成できます。
 * @author SumRndmDde
 *
 * @param Active Updating
 * @text 自動更新
 ...
 * @on 有効
 * @off 無効
 * @desc エディタでプロパティが変更される度に、HUDのピースが自動的に更新
 * 有効:true / 無効:false
 * @default false
 *
 * @param Show During Events
 ...
 * @value transparent
 * @desc イベント処理中のHUDの挙動
 * 非表示:hide / 表示:show / 透過:transparent
 * @default transparent
 *
 * @param Map Global Condition
 * @text マップ表示条件
 * @desc マップ上でHUDが表示される条件式
 * trueを返すと表示
 * @default
 *
 * @param Battle Global Condition
 * @text 戦闘表示条件
 * @desc 戦闘でHUDが表示される条件式
 * trueを返すと表示
 * @default
 *
 * @param Disable Delete Key
 ...
 *
 * 元プラグイン: http://sumrndm.site/hud-maker/
 *
 *
 * HUD Maker
 * Version 1.42
 ...
 *
 * このプラグインを使用すると、
 * 開発者がゲーム内のGUIウィンドウを介して独自のマップベースのHUDを
 * 作成することができます!
 *
