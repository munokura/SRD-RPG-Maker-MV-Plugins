 ...
 */
/*:ja
 * @plugindesc イベント、敵キャラ、武器の色変換を可能にする様々な画像操作機能を追加します。
 * @author SumRndmDde
 *
 * @param Default Font
 * @text デフォルトのフォント
 ...
 * @text デフォルトのフォントサイズ
 * @type number
 * @desc 画像デフォルトのフォントサイズ
 * @default 28
 *
 * @param Default Font Italic
 * @text デフォルトのフォントイタリック
 * @type boolean
 * @on 有効
 * @off 無効
 * @desc 画像デフォルトのフォントイタリック
 * 有効:true / 無効:false
 * @default false
 *
 * @param Default Text Color
 ...
 * @param Default Outline Color
 * @text デフォルトのアウトライン色
 * @desc 画像デフォルトのアウトライン色
 * @default rgba(0, 0, 0, 0.5)
 *
 * @param Default Outline Width
 * @text デフォルトのアウトライン幅
 * @type number
 * @desc 画像デフォルトのアウトライン幅
 * @default 4
 *
 * @help
 * 翻訳:ムノクラ
 ...
 *
 * 元プラグイン: http://sumrndm.site/bitmap-upgrade/
 *
 *
 * Bitmap Upgrade
 * Version 1.01
 ...
 * ==========================================================================
 *
 * 武器のトーン、色相、彩度、明度は、以下のメモタグを使って変更できます。
 *
 *
 *   <Weapon Tone: [red], [green], [blue]>
 *   <Weapon Hue: [shift]>
 ...
 *   <Weapon Lightness: [shift]>
 *
 * 上記で、武器のビットマップのトーン、色相、彩度、明度を変更します。
 *
 *
 * ==========================================================================
 *  イベントのメモタグ
 * ==========================================================================
 *
 * イベントは、以下のメモタグを使ってトーン、色相、彩度、明度を変更できます。
 *
 *   <Tone: [red], [green], [blue]>
 *   <Hue: [shift]>
 *   <Saturation: [shift]>
