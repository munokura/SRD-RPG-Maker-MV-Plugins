 ...
 */
/*:ja
 * @plugindesc 戦闘背景をX方向とY方向の両方にスクロールできます。
 * @author SumRndmDde
 * @help
 * 翻訳:ムノクラ
 ...
 *
 * 元プラグイン: http://sumrndm.site/battle-back-scroll/
 *
 *
 * Battle Background Scroll
 * Version 1.00
 ...
 * ==========================================================================
 *
 * スクロールを敵グループの戦闘背景に設定するには、
 * 敵グループの名前欄内に以下のメモタグを使用します。
 *
 *   <back1-speed: [xspeed], [yspeed]>
 *   <back2-speed: [xspeed], [yspeed]>
 * これらを使用して、戦闘背景1と背景2にXとYの速度を設定することができます。
 *
 * 例:
 *
 *   Bat*2  <back1-speed: 4, 0> <back2-speed: 0, -3>
 *
 *
 * ==========================================================================
 *  プラグインコマンド
 ...
 *
 * 以下のプラグインコマンドを使用して、
 * 背景の真ん中にある戦闘背景の速度を変更することができます。
 *
 *   SetBattleBack1ScrollSpeed [xspeed] [yspeed]
 *   SetBattleBack2ScrollSpeed [xspeed] [yspeed]
 *
 * これらのプラグインコマンドはとてもシンプルです。
 * これらのコマンドを使って、戦闘背景1と2をそれぞれ操作することができます。
 * 'xspeed'と'yspeed'に、使いたいXとYの速度を設定します。
 *
 * 例:
 *
 *   SetBattleBack1ScrollSpeed 3 6
