 ...
 */
/*:ja
 * @plugindesc 全てのメニューにカスタム背景を設定できます。
 * @author SumRndmDde
 * 
 * @param Scale Background
 * @text 背景の自動の拡縮
 ...
 * @param Menu Background
 * @text メニューの背景
 * @desc メインメニュー画面で使用される背景
 * (img/SumRndmDde/menu/)に保存
 * @default
 * 
 * @param Menu Opacity
 * @text メニューの不透明度
 ...
 * 
 * 元プラグイン: http://sumrndm.site/menu-backgrounds/
 * 
 * Menu Backgrounds
 * Version 2.05
 * SumRndmDde
 * 
 * 
 * 全てのメニューにカスタム背景を設定できます。
 * 
 * 背景画像の縮尺、メニュー内のウィンドウの不透明度、
 * 背景画像のモーションを設定できます。
 * 
 * 
 * ==========================================================================
 ...
 * img/SumRndmDde/menu
 * 
 * デプロイメント時、imgフォルダ内のSumRndmDdeフォルダをコピーするためです。
 * 選択したパラメータにファイル拡張子を除いた画像名を入力すると
 * 動作するはずです。
 * 
 * 
 * ==========================================================================
 ...
 * ==========================================================================
 * 
 * カスタムメニューシーンに背景を設定するには、
 * 'Custom X Scene'にシーン名を入力します。
 * 次に、そのシーンに持たせたいその他の情報を、
 * 他のCustom Xパラメータに入力します。
 * 
 * 
 * ==========================================================================
 *  背景画像のモーション
 * ==========================================================================
 * 
 * 'Motion'パラメータで使用できるモーションの一覧です。
 * 
 * ==========================================================================
 * 
 *   scroll [xSpeed] [ySpeed]
 * 
 * 上記でXとYの速度で背景がスクロールします。
 * 
 * 例:
 *    scroll 3 3
 * 
