 ...
 */
/*:ja
 * @plugindesc SumRndmDde のライブラリからプラグインの更新をチェックするツールを Super Tools Engine に追加します。
 * @author SumRndmDde
 * @help
 * 翻訳:ムノクラ
 ...
 *
 * 元プラグイン: http://sumrndm.site/plugin-updater/
 *
 *
 * Plugin Updater
 * Version 1.21
 ...
 *
 *
 * SumRndmDdeのライブラリからプラグインの更新をチェックするツールを
 ...
 *
 * テストプレイ中にF12を押してテストプレイエディタから使用します。
 *
 *
 * ==========================================================================
 *  機能概要
 * ==========================================================================
 *
 * "Plugin Updater"ツールが追加されます。
 * このツールは、
 * プロジェクトにインストールされている全てのSRDプラグインをリストアップします。
 * プロジェクトにインストールされているプラグインの現在のバージョンと、
 * 利用可能な最新バージョンが表示されます。
 * また、簡単にアクセスできるようにプラグインのページへのリンクを表示します。
 *
 * また、プラグインにアップデートがある場合は開発者に通知します。
 * ツールの説明では、
 * プラグインに新しいアップデートがあるかどうかを開発者に通知します。
 * さらに、アップデートが利用可能なプラグインには、
 * リストの横に赤い'N'が表示されます。
 *
 * 目的のプラグインが更新されたら、
 * プラグインが更新されたと登録されていることを確認するために
 * ゲームをリロードすることができます。
 *
 *
 * ==========================================================================
