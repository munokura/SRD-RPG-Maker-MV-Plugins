 ...
 */
/*:ja
 * @plugindesc メインメニューをFF7っぽくします。
 * @author SumRndmDde
 *
 * @param "To Next Level" Text
 * @text '次のレベルまで'テキスト
 * @desc メニューの'次のレベルまで'に使用するテキストです。
 * @default 次のレベルまで
 *
 * @param "Play Time" Text
 * @text 'プレイ時間'テキスト
 * @desc メニューの'プレイ時間'に使用するテキストです。
 * @default プレイ時間
 *
 * @param Squish "Play Time"
 * @text ストレッチ'プレイ時間'
 ...
 * @off 非表示
 * 表示:true / 非表示:false
 * @desc '場所'にマップの'表示名'を表示
 * @default true
 *
 * @param EXP Color 1
 * @text 経験値色1
 * @desc 経験値色1
 * JavaScriptまたはHTMLの色を入力します。
 * @default #800080
 *
 * @param EXP Color 2
 * @text 経験値色2
 ...
 *
 * 元プラグイン: http://sumrndm.site/ams-final-fantasy-7/
 *
 *
 * Alternative Menu Screen: Final Fantasy 7
 * Version 1.02
