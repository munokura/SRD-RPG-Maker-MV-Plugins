 ...
 */
/*:ja
 * @plugindesc オプションメニューにマスターボリュームを変更するオプションを追加します。
 * @author SumRndmDde
 * 
 * @param Option Name
 * @text オプション名
 * @desc マスターボリュームオプションの表示名
 * @default マスターボリューム
 * 
 * @param Default Value
 * @text デフォルト値
 ...
 * @option ボリューム下
 * @value BelowVol
 * @desc オプションメニューでのオプションの位置
 * 上:Above / 下:Below / ボリューム上:AboveVol / ボリューム下:BelowVol
 * @default AboveVol
 * 
 * @help
 * 翻訳:ムノクラ
 ...
 * 
 * 元プラグイン: http://sumrndm.site/master-volume/
 * 
 * 
 * Master Volume
 * Version 1.00
 ...
 * 
 * 
 * オプションメニューにマスターボリュームを変更するオプションを追加します。
 * 
 * 
 * ==========================================================================
 *  ヘルプファイルの終わり
